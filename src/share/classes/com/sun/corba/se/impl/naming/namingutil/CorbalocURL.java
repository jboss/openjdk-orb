...
public class CorbalocURL extends INSURLBase
{
        ...
        if( url != null ) {
            ...
            while( endpoints.hasMoreTokens( ) ) {
                ...
                if( endpointInfo.startsWith( "iiop:" ) ) {
                    iiopEndpointInfo = handleColon( endpointInfo, "iiop" );
                } else if (endpointInfo.startsWith("ssliop:")){
                    iiopEndpointInfo = handleColon( endpointInfo, "ssliop" );
     ...
     */
    private IIOPEndpointInfo handleColon( String iiopInfo, String protocol ) {
        iiopInfo = iiopInfo.substring( protocol.length() );
        IIOPEndpointInfo iiopEndpointInfo = new IIOPEndpointInfo();
        if(protocol.equals( "ssliop" )) {
