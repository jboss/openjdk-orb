...
public abstract class _ServerManagerImplBase extends org.omg.CORBA.portable.ObjectImpl
    ...
    static {
        _methods.put("active", 0);
        _methods.put("registerEndpoints", 1);
        _methods.put("getActiveServers", 2);
        _methods.put("activate", 3);
        _methods.put("shutdown", 4);
        _methods.put("install", 5);
        _methods.put("getORBNames", 6);
        _methods.put("uninstall", 7);
        _methods.put("locateServer", 8);
        _methods.put("locateServerForORB", 9);
        _methods.put("getEndpoint", 10);
        _methods.put("getServerPortForType", 11);
    }
